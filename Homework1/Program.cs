...
namespace Homework1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            while (!reader.EndOfStream)
            {
                ...
                Vote vote = new Vote(values[0], values[1], values[2], values[3], values[4], values[5], values[6], values[7], values[8], values[9]);
                voteList.Add(vote);
    ...
    internal class Vote
    {
        ...
        public Vote() { }
        public Vote(string a, string b, string c, string d, string e, string f, string g, string h, string i, string j)
        {
            this.Number = a;
